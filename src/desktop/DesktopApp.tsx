...
import { playPositionPitch, preloadPositionPitch, waitForActivePitchPlayback, type GuitarToneId } from '../app/audio';
import {
  formatSolfeggio,
  isSolfeggio,
...
import {
  ...
  isAnswerCorrect,
  isSlowAnswer,
} from '../domain/fretboard-game/practiceSession';
import { ADAPTIVE_PRACTICE_CONFIG } from '../domain/fretboard-game/adaptivePracticeConfig';
import { PRACTICE_INTERACTION_CONFIG } from '../domain/fretboard-game/practiceInteractionConfig';
import {
  clearPracticeMemory,
...
import type {
  ...
  PracticeAnswerValue,
  PracticeModeId,
} from '../domain/fretboard-game/types';
